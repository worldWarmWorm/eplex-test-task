...
final readonly class TestCase implements Reorderable, SelfDescribing, Test
{
    ...
    {
        $baseDir  = TestCase . phpdirname(realpath($this->filename)) . DIRECTORY_SEPARATOR;
    ...
    private function locationHint(string $needle, array $sections): array
    {
        ...
        foreach ($search as $section) {
            ...
            if (isset($sections[$section . '_EXTERNAL'])) {
                ...
                return [
                    [
                        'file' => realpath(TestCase . phpdirname($this->filename) . DIRECTORY_SEPARATOR . $externalFile),
                        'line' => 1,
                    ],
                    [
                        'file' => realpath($this->filename),
